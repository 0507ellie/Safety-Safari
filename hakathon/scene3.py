...
# 載入圖片
program_image = pygame.image.load('program.png')  # 請替換為程式的圖片路徑
open_space_image = pygame.image.load('open_space.png')  # 請替換為 open space 的圖片路徑
...
# 顯示開始提示
show_message("On your way back to home, another earthquake hits")
                ...
                for event in pygame.event.get():
                    ...
                    if event.type == pygame.MOUSEBUTTONDOWN:
                        ...
                        if continue_button_rect.collidepoint(mouse_x, mouse_y):
                            ...
                            os.system('python scene4.py')  # This will run scene3.py
